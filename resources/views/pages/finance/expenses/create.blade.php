...
<form action="{{ route('expense.store') }}" method="POST" class="card cio-card">
    @csrf
    <div class="cio-card-header d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div class="cio-subtitle">Isi transaksi biaya, vendor, dan biaya admin</div>
        </div>
    </div>
    <div class="card-body">
        @include('pages.finance.expenses.form', ['expense' => null])
    </div>
