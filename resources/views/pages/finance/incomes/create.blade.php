...
<form action="{{ route('income.store') }}" method="POST" class="card cio-card">
    @csrf
    <div class="cio-card-header d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div class="cio-subtitle">Isi transaksi dana masuk baru</div>
        </div>
    </div>
    <div class="card-body">
        @include('pages.finance.incomes.form', ['income' => null])
    </div>
